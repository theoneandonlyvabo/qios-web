...
-- Mencatat setiap aksi admin: suspend, edit plan, akses data, dll (A-06).
...
CREATE TABLE IF NOT EXISTS admin_audit_logs (
    ...
    target_id   UUID,                    -- ID dari entitas yang diubah
    action      VARCHAR(100) NOT NULL,   -- e.g. 'suspend_user', 'change_plan', 'extend_subscription'
